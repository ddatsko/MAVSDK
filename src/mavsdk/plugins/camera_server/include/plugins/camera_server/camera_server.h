...
public:
    ...
    enum class VideoStreamType {
        Rtsp, /**< @brief Stream is RTSP. */
        RtpUdp, /**< @brief Stream is RTP UDP (URI gives the port number). */
        TcpMpeg, /**< @brief Stream is MPEG on TCP. */
        MpegTs, /**< @brief Stream is MPEG TS (URI gives the port number). */
    };
    ...
    enum class VideoStreamStatusFlags {
        None, /**< @brief No flags set. */
        Running, /**< @brief Stream is active (running). */
        Thermal, /**< @brief Stream is thermal imaging. */
        ThermalRangeEnabled, /**< @brief Stream can report absolute thermal range. */
    };
    ...
    friend std::ostream& operator<<(
        std::ostream& str, CameraServer::VideoStreamStatusFlags const& video_stream_status_flags);
    ...
    struct VideoStreaming {
        ...
        uint32_t resolution_h{}; /**< @brief Horizontal resolution in pixels */
        uint32_t resolution_v{}; /**< @brief Vertical resolution in pixels */
        uint32_t bitrate_b_s{}; /**< @brief Bit rate in bits per second */
        uint32_t rotation_deg{}; /**< @brief Video image rotation clockwise in degrees */
        uint32_t hfov_deg{}; /**< @brief Horizontal field of view in degrees */
        std::string name{}; /**< @brief Stream name */
        uint32_t stream_id{}; /**< @brief Stream ID (1 for first, 2 for second, etc.) */
        uint32_t count{}; /**< @brief Number of streams available */
