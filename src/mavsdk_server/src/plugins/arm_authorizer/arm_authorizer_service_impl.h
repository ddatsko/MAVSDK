...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/arm_authorizer/arm_authorizer.proto)
...
public:
    ...
    static rpc::arm_authorizer::ArmAuthorizerDecision translateToRpcArmAuthorizerDecision(const mavsdk::ArmAuthorizer::ArmAuthorizerDecision& arm_authorizer_decision)
    {
    ...
    static mavsdk::ArmAuthorizer::ArmAuthorizerDecision translateFromRpcArmAuthorizerDecision(const rpc::arm_authorizer::ArmAuthorizerDecision arm_authorizer_decision)
    {
        switch (arm_authorizer_decision) {
            default:
                LogErr() << "Unknown arm_authorizer_decision enum value: " << static_cast<int>(arm_authorizer_decision);
    ...
    static rpc::arm_authorizer::CommandAnswer translateToRpcCommandAnswer(const mavsdk::ArmAuthorizer::CommandAnswer& command_answer)
    {
    ...
    static mavsdk::ArmAuthorizer::CommandAnswer translateFromRpcCommandAnswer(const rpc::arm_authorizer::CommandAnswer command_answer)
    {
        switch (command_answer) {
            default:
                LogErr() << "Unknown command_answer enum value: " << static_cast<int>(command_answer);
    ...
    grpc::Status SubscribeArmAuthorization(grpc::ServerContext* /* context */, const mavsdk::rpc::arm_authorizer::SubscribeArmAuthorizationRequest* /* request */, grpc::ServerWriter<rpc::arm_authorizer::ArmAuthorizationResponse>* writer) override
    {
        ...
        const mavsdk::ArmAuthorizer::ArmAuthorizationHandle handle = _lazy_plugin.maybe_plugin()->subscribe_arm_authorization(
        ...
        rpc::arm_authorizer::RespondArmAuthorizationResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_arm_authorization(translateFromRpcArmAuthorizerDecision(request->arm_authorizer_decision()));
